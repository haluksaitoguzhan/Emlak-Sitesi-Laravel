    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center"href="{{ route('admin_panel')}}">
                ...
                <div class="sidebar-brand-text mx-3">Admİn Panel</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item @if(Request::segment(3) == 'bekleyen_ilanlar') active @endif" href="{{ route('admin_onay_bekleyenler') }}">Onay Bekleyenler</a>
                        <a class="collapse-item @if(Request::segment(3) == 'onaylanan_ilanlar') active @endif" href="{{ route('admin_onaylanmis_ilanlar') }}">Onaylanmış İlanlar</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="{{ route('admin_cikis') }}" data-toggle="modal" data-target="#logoutModal">
                ...
                <div class="container-fluid">
                    ...
                    @if(Request::segment(3) == 'bekleyen_ilanlar')
                        <h1 class="h3 mb-2 text-gray-800">Onay Bekleyen İlanlar</h1>
                    @elseif(Request::segment(3) == 'onaylanan_ilanlar')
                        <h1 class="h3 mb-2 text-gray-800">Onaylanmış İlanlar</h1>
                    @else
                        <h1 class="h3 mb-2 text-gray-800">@yield('title')</h1>
                    @endif
